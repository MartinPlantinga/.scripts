  ...
  ;%***********************
    ...
    ;%
	  ...
	  ;% RA3_P.DiscreteDerivative_ICPrevScaled
	  section.data(1).logicalSrcIdx = 0;
	  section.data(1).dtTransOffset = 0;
	
	  ;% RA3_P.DiscreteDerivative_ICPrevScal_k
	  section.data(2).logicalSrcIdx = 1;
	  section.data(2).dtTransOffset = 1;
	
	  ;% RA3_P.DiscreteDerivative_ICPrevScal_h
	  section.data(3).logicalSrcIdx = 2;
	  section.data(3).dtTransOffset = 2;
	
	  ;% RA3_P.CompareToConstant_const
	  ...
	  ;% RA3_P.ReferenceSolenoid_Value
	  section.data(15).logicalSrcIdx = 14;
	  section.data(15).dtTransOffset = 14;
	
	  ;% RA3_P.SFunction_P1_Size
	  ...
	  ;% RA3_P.Constant4_Value
	  section.data(18).logicalSrcIdx = 17;
	  section.data(18).dtTransOffset = 18;
	
	  ;% RA3_P.Constant3_Value
	  section.data(19).logicalSrcIdx = 18;
	  section.data(19).dtTransOffset = 19;
	
	  ;% RA3_P.HomingRunningSwitch_Threshold
	  section.data(20).logicalSrcIdx = 19;
	  section.data(20).dtTransOffset = 20;
	
	  ;% RA3_P.HomingRunningSwitch_Threshold_l
	  section.data(21).logicalSrcIdx = 20;
	  section.data(21).dtTransOffset = 21;
	
	  ;% RA3_P.HomingRunningSwitch_Threshold_i
	  section.data(22).logicalSrcIdx = 21;
	  section.data(22).dtTransOffset = 22;
	
	  ;% RA3_P.ec_Ebox_P1_Size
	  ...
	  ;% RA3_P.DiscreteTimeIntegrator_gainval
	  section.data(25).logicalSrcIdx = 24;
	  section.data(25).dtTransOffset = 26;
	
	  ;% RA3_P.DiscreteTimeIntegrator_IC
	  section.data(26).logicalSrcIdx = 25;
	  section.data(26).dtTransOffset = 27;
	
	  ;% RA3_P.Constant1_Value
	  section.data(27).logicalSrcIdx = 26;
	  section.data(27).dtTransOffset = 28;
	
	  ;% RA3_P.DiscreteTimeIntegrator_gainva_e
	  ...
	  ;% RA3_P.Dct2lowpass_P1_Size_d
	  section.data(81).logicalSrcIdx = 80;
	  section.data(81).dtTransOffset = 117;
	
	  ;% RA3_P.Dct2lowpass_P1_h
	  ...
	  ;% RA3_P.Dct2lowpass_P1_Size_a
	  section.data(101).logicalSrcIdx = 100;
	  section.data(101).dtTransOffset = 161;
	
	  ;% RA3_P.Dct2lowpass_P1_n
	  ...
	  ;% RA3_P.LimitAcceleration_RisingLim
  ...
  ;%*******************
    ...
    ;%
	  ...
	  ;% RA3_DW.DiscreteTimeIntegrator_DSTATE
	  section.data(1).logicalSrcIdx = 0;
	  section.data(1).dtTransOffset = 0;
	  ...
	  ;% RA3_DW.currentcarPos
	  section.data(17).logicalSrcIdx = 16;
	  section.data(17).dtTransOffset = 16;
	
	  ;% RA3_DW.Dctintegrator_RWORK
	  section.data(18).logicalSrcIdx = 17;
  ...
  targMap.checksum0 = 2345506916;
  targMap.checksum1 = 267580224;
  targMap.checksum2 = 3798723068;
  targMap.checksum3 = 3880460234;
