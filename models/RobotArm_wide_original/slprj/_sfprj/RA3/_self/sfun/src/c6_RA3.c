...
static void c6_durationReferenceTimeUpdater(SFc6_RA3InstanceStruct
  *chartInstance);
static void initialize_c6_RA3(SFc6_RA3InstanceStruct *chartInstance);
static void initialize_params_c6_RA3(SFc6_RA3InstanceStruct *chartInstance);
static void enable_c6_RA3(SFc6_RA3InstanceStruct *chartInstance);
static void disable_c6_RA3(SFc6_RA3InstanceStruct *chartInstance);
static void c6_update_debugger_state_c6_RA3(SFc6_RA3InstanceStruct
  *chartInstance);
static void ext_mode_exec_c6_RA3(SFc6_RA3InstanceStruct *chartInstance);
static const mxArray *get_sim_state_c6_RA3(SFc6_RA3InstanceStruct *chartInstance);
static void set_sim_state_c6_RA3(SFc6_RA3InstanceStruct *chartInstance, const
  mxArray *c6_st);
static void c6_set_sim_state_side_effects_c6_RA3(SFc6_RA3InstanceStruct
  *chartInstance);
static void finalize_c6_RA3(SFc6_RA3InstanceStruct *chartInstance);
static void sf_gateway_c6_RA3(SFc6_RA3InstanceStruct *chartInstance);
static void mdl_start_c6_RA3(SFc6_RA3InstanceStruct *chartInstance);
static void c6_chartstep_c6_RA3(SFc6_RA3InstanceStruct *chartInstance);
static void initSimStructsc6_RA3(SFc6_RA3InstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c6_machineNumber, uint32_T
  c6_chartNumber, uint32_T c6_instanceNumber);
static const mxArray *c6_sf_marshallOut(void *chartInstanceVoid, void *c6_inData);
static int32_T c6_emlrt_marshallIn(SFc6_RA3InstanceStruct *chartInstance, const
  mxArray *c6_u, const emlrtMsgIdentifier *c6_parentId);
static void c6_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c6_mxArrayInData, const char_T *c6_varName, void *c6_outData);
static const mxArray *c6_b_sf_marshallOut(void *chartInstanceVoid, void
  *c6_inData);
static real_T c6_b_emlrt_marshallIn(SFc6_RA3InstanceStruct *chartInstance, const
  mxArray *c6_b_jogSpeed, const char_T *c6_identifier);
static real_T c6_c_emlrt_marshallIn(SFc6_RA3InstanceStruct *chartInstance, const
  mxArray *c6_u, const emlrtMsgIdentifier *c6_parentId);
static void c6_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c6_mxArrayInData, const char_T *c6_varName, void *c6_outData);
static const mxArray *c6_c_sf_marshallOut(void *chartInstanceVoid, void
  *c6_inData);
static uint8_T c6_d_emlrt_marshallIn(SFc6_RA3InstanceStruct *chartInstance,
  const mxArray *c6_b_is_active_c6_RA3, const char_T *c6_identifier);
static uint8_T c6_e_emlrt_marshallIn(SFc6_RA3InstanceStruct *chartInstance,
  const mxArray *c6_u, const emlrtMsgIdentifier *c6_parentId);
static uint16_T c6_f_emlrt_marshallIn(SFc6_RA3InstanceStruct *chartInstance,
  const mxArray *c6_b_temporalCounter_i1, const char_T *c6_identifier);
static uint16_T c6_g_emlrt_marshallIn(SFc6_RA3InstanceStruct *chartInstance,
  const mxArray *c6_u, const emlrtMsgIdentifier *c6_parentId);
static const mxArray *c6_h_emlrt_marshallIn(SFc6_RA3InstanceStruct
  *chartInstance, const mxArray *c6_b_setSimStateSideEffectsInfo, const char_T
  *c6_identifier);
static const mxArray *c6_i_emlrt_marshallIn(SFc6_RA3InstanceStruct
  *chartInstance, const mxArray *c6_u, const emlrtMsgIdentifier *c6_parentId);
static const mxArray *sf_get_hover_data_for_msg(SFc6_RA3InstanceStruct
  *chartInstance, int32_T c6_ssid);
static void c6_init_sf_message_store_memory(SFc6_RA3InstanceStruct
  *chartInstance);
static void init_dsm_address_info(SFc6_RA3InstanceStruct *chartInstance);
static void init_simulink_io_address(SFc6_RA3InstanceStruct *chartInstance);
...
static void initialize_c6_RA3(SFc6_RA3InstanceStruct *chartInstance)
{
  if (sf_is_first_init_cond(chartInstance->S)) {
    initSimStructsc6_RA3(chartInstance);
  ...
  *chartInstance->c6_temporalCounter_i1 = 0U;
  *chartInstance->c6_temporalCounter_i1 = 0U;
  *chartInstance->c6_is_active_c6_RA3 = 0U;
  *chartInstance->c6_is_c6_RA3 = c6_IN_NO_ACTIVE_CHILD;
...
static void ext_mode_exec_c6_RA3(SFc6_RA3InstanceStruct *chartInstance)
{
  c6_update_debugger_state_c6_RA3(chartInstance);
}
  ...
  mxArray *c6_st)
{
  ...
  *chartInstance->c6_is_active_c6_RA3 = c6_d_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell("is_active_c6_RA3", c6_u, 10)), "is_active_c6_RA3");
  *chartInstance->c6_is_c6_RA3 = c6_d_emlrt_marshallIn(chartInstance, sf_mex_dup
    (sf_mex_getcell("is_c6_RA3", c6_u, 11)), "is_c6_RA3");
...
static void sf_gateway_c6_RA3(SFc6_RA3InstanceStruct *chartInstance)
{
  c6_set_sim_state_side_effects_c6_RA3(chartInstance);
  ...
  _SFD_DATA_RANGE_CHECK((real_T)*chartInstance->c6_homeSwitch, 0U, 1U, 0U,
                        *chartInstance->c6_sfEvent, false);
  *chartInstance->c6_sfEvent = CALL_EVENT;
  c6_chartstep_c6_RA3(chartInstance);
...
static void c6_chartstep_c6_RA3(SFc6_RA3InstanceStruct *chartInstance)
{
  ...
  if (*chartInstance->c6_is_active_c6_RA3 == 0U) {
    _SFD_CC_CALL(CHART_ENTER_ENTRY_FUNCTION_TAG, 2U, *chartInstance->c6_sfEvent);
    *chartInstance->c6_is_active_c6_RA3 = 1U;
    ...
    *chartInstance->c6_is_c6_RA3 = c6_IN_WaitForZ;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 8U, *chartInstance->c6_sfEvent);
    *chartInstance->c6_temporalCounter_i1 = 0U;
    *chartInstance->c6_toPoint = 0.0;
    ...
    *chartInstance->c6_jogSpeed = 0.0;
    ...
    switch (*chartInstance->c6_is_c6_RA3) {
     case c6_IN_AirbagLeft:
      ...
      if (c6_out) {
        ...
        _SFD_CS_CALL(STATE_INACTIVE_TAG, 0U, *chartInstance->c6_sfEvent);
        *chartInstance->c6_is_c6_RA3 = c6_IN_DisableOutputs;
        _SFD_CS_CALL(STATE_ACTIVE_TAG, 2U, *chartInstance->c6_sfEvent);
     ...
     case c6_IN_EnableRunAndSafety:
      ...
      if (c6_c_out) {
        ...
        _SFD_CS_CALL(STATE_INACTIVE_TAG, 3U, *chartInstance->c6_sfEvent);
        *chartInstance->c6_is_c6_RA3 = c6_IN_AirbagLeft;
        _SFD_CS_CALL(STATE_ACTIVE_TAG, 0U, *chartInstance->c6_sfEvent);
        *chartInstance->c6_temporalCounter_i1 = 0U;
        ...
        *chartInstance->c6_airBagRef = -0.1;
        ...
        if (c6_d_out) {
          ...
          _SFD_CS_CALL(STATE_INACTIVE_TAG, 3U, *chartInstance->c6_sfEvent);
          *chartInstance->c6_is_c6_RA3 = c6_IN_AirbagRight;
          _SFD_CS_CALL(STATE_ACTIVE_TAG, 1U, *chartInstance->c6_sfEvent);
          *chartInstance->c6_temporalCounter_i1 = 0U;
          *chartInstance->c6_airBagEnabled = 1.0;
     ...
     case c6_IN_Homing:
      ...
      if (c6_e_out) {
        ...
        _SFD_CS_CALL(STATE_INACTIVE_TAG, 4U, *chartInstance->c6_sfEvent);
        *chartInstance->c6_is_c6_RA3 = c6_IN_MovetoX0;
        _SFD_CS_CALL(STATE_ACTIVE_TAG, 5U, *chartInstance->c6_sfEvent);
        *chartInstance->c6_temporalCounter_i1 = 0U;
        *chartInstance->c6_jogSpeed = 0.0;
     ...
     case c6_IN_MovetoX0:
      ...
      if (c6_f_out) {
        ...
        _SFD_CS_CALL(STATE_INACTIVE_TAG, 5U, *chartInstance->c6_sfEvent);
        *chartInstance->c6_is_c6_RA3 = c6_IN_WaitForRest;
        _SFD_CS_CALL(STATE_ACTIVE_TAG, 7U, *chartInstance->c6_sfEvent);
        *chartInstance->c6_Ready = 1.0;
     ...
     case c6_IN_ResetEnc:
      ...
      if (c6_g_out) {
        ...
        _SFD_CS_CALL(STATE_INACTIVE_TAG, 6U, *chartInstance->c6_sfEvent);
        *chartInstance->c6_is_c6_RA3 = c6_IN_EnableRunAndSafety;
        _SFD_CS_CALL(STATE_ACTIVE_TAG, 3U, *chartInstance->c6_sfEvent);
        *chartInstance->c6_resetEnc = 0.0;
     ...
     case c6_IN_WaitForRest:
      ...
      if (c6_h_out) {
        ...
        _SFD_CS_CALL(STATE_INACTIVE_TAG, 7U, *chartInstance->c6_sfEvent);
        *chartInstance->c6_is_c6_RA3 = c6_IN_ResetEnc;
        _SFD_CS_CALL(STATE_ACTIVE_TAG, 6U, *chartInstance->c6_sfEvent);
        *chartInstance->c6_temporalCounter_i1 = 0U;
     ...
     case c6_IN_WaitForZ:
      ...
      if (c6_i_out) {
        ...
        _SFD_CS_CALL(STATE_INACTIVE_TAG, 8U, *chartInstance->c6_sfEvent);
        *chartInstance->c6_is_c6_RA3 = c6_IN_Homing;
        _SFD_CS_CALL(STATE_ACTIVE_TAG, 4U, *chartInstance->c6_sfEvent);
...
const mxArray *sf_c6_RA3_get_eml_resolved_functions_info(void)
{
...
static const mxArray *c6_sf_marshallOut(void *chartInstanceVoid, void *c6_inData)
{
  ...
  int32_T c6_u;
  const mxArray *c6_y = NULL;
  SFc6_RA3InstanceStruct *chartInstance;
  chartInstance = (SFc6_RA3InstanceStruct *)chartInstanceVoid;
  ...
  const mxArray *c6_b_is_active_c6_RA3, const char_T *c6_identifier)
{
  ...
  c6_thisId.fParent = NULL;
  c6_thisId.bParentIsCell = false;
  c6_y = c6_e_emlrt_marshallIn(chartInstance, sf_mex_dup(c6_b_is_active_c6_RA3),
    &c6_thisId);
  sf_mex_destroy(&c6_b_is_active_c6_RA3);
  return c6_y;
}
...
static void init_simulink_io_address(SFc6_RA3InstanceStruct *chartInstance)
{
  ...
  chartInstance->c6_isStable = (boolean_T *)ssGetDWork_wrapper(chartInstance->S,
    1);
  chartInstance->c6_is_active_c6_RA3 = (uint8_T *)ssGetDWork_wrapper
    (chartInstance->S, 2);
  chartInstance->c6_is_c6_RA3 = (uint8_T *)ssGetDWork_wrapper(chartInstance->S,
    3);
...
void sf_c6_RA3_get_check_sum(mxArray *plhs[])
{
...
mxArray* sf_c6_RA3_get_post_codegen_info(void);
mxArray *sf_c6_RA3_get_autoinheritance_info(void)
{
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c6_RA3_get_post_codegen_info();
...
mxArray *sf_c6_RA3_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c6_RA3_jit_fallback_info(void)
{
...
mxArray *sf_c6_RA3_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c6_RA3(void)
{
  ...
  const char *infoEncStr[] = {
    ...
    "100 S1x3'type','srcId','name','auxInfo'{{M[8],M[0],T\"is_active_c6_RA3\",},{M[9],M[0],T\"is_c6_RA3\",},{M[11],M[0],T\"temporalCounter_i1\",S'et','os','ct'{{T\"at\",M1x5[71 19 58 74 107],M[1]}}}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 13, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c6_RA3_get_check_sum(&mxChecksum);
...
static const mxArray* sf_opaque_get_hover_data_for_msg(void* chartInstance,
  int32_T msgSSID)
{
  return sf_get_hover_data_for_msg( (SFc6_RA3InstanceStruct *) chartInstance,
    msgSSID);
}
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc6_RA3InstanceStruct *chartInstance = (SFc6_RA3InstanceStruct *)
...
static void sf_opaque_initialize_c6_RA3(void *chartInstanceVar)
{
  sf_check_dwork_consistency(((SFc6_RA3InstanceStruct*) chartInstanceVar)->S);
  chart_debug_initialization(((SFc6_RA3InstanceStruct*) chartInstanceVar)->S,0);
  initialize_params_c6_RA3((SFc6_RA3InstanceStruct*) chartInstanceVar);
  initialize_c6_RA3((SFc6_RA3InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c6_RA3(void *chartInstanceVar)
{
  enable_c6_RA3((SFc6_RA3InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c6_RA3(void *chartInstanceVar)
{
  disable_c6_RA3((SFc6_RA3InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c6_RA3(void *chartInstanceVar)
{
  sf_gateway_c6_RA3((SFc6_RA3InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_ext_mode_exec_c6_RA3(void *chartInstanceVar)
{
  ext_mode_exec_c6_RA3((SFc6_RA3InstanceStruct*) chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c6_RA3(SimStruct* S)
{
  return get_sim_state_c6_RA3((SFc6_RA3InstanceStruct *)
    sf_get_chart_instance_ptr(S));     /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c6_RA3(SimStruct* S, const mxArray *st)
{
  set_sim_state_c6_RA3((SFc6_RA3InstanceStruct*)sf_get_chart_instance_ptr(S), st);
}

static void sf_opaque_terminate_c6_RA3(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc6_RA3InstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
      unload_RA3_optimization_info();
    }

    finalize_c6_RA3((SFc6_RA3InstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc6_RA3((SFc6_RA3InstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c6_RA3(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c6_RA3((SFc6_RA3InstanceStruct*)sf_get_chart_instance_ptr
      (S));
  }
}

mxArray *sf_c6_RA3_get_testpoint_info(void)
{
  const char *infoEncStr[] = {
    "100 S1x2'varName','path'{{T\"is_active_c6_RA3\",T\"is_active_c6_RA3\"},{T\"is_c6_RA3\",T\"is_c6_RA3\"}}"
  };
...
static void mdlSetWorkWidths_c6_RA3(SimStruct *S)
{
...
static void mdlRTW_c6_RA3(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c6_RA3(SimStruct *S)
{
  SFc6_RA3InstanceStruct *chartInstance;
  chartInstance = (SFc6_RA3InstanceStruct *)utMalloc(sizeof
    (SFc6_RA3InstanceStruct));
  if (chartInstance==NULL) {
    sf_mex_error_message("Could not allocate memory for chart instance.");
  }

  memset(chartInstance, 0, sizeof(SFc6_RA3InstanceStruct));
  chartInstance->chartInfo.chartInstance = chartInstance;
  chartInstance->chartInfo.isEMLChart = 0;
  chartInstance->chartInfo.chartInitialized = 0;
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c6_RA3;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c6_RA3;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c6_RA3;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c6_RA3;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c6_RA3;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c6_RA3;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c6_RA3;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c6_RA3;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c6_RA3;
  chartInstance->chartInfo.mdlStart = mdlStart_c6_RA3;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c6_RA3;
  chartInstance->chartInfo.callGetHoverDataForMsg =
    sf_opaque_get_hover_data_for_msg;
  chartInstance->chartInfo.extModeExec = sf_opaque_ext_mode_exec_c6_RA3;
  ...
  mdl_start_c6_RA3(chartInstance);
}

void c6_RA3_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   ...
   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c6_RA3(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c6_RA3(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c6_RA3_method_dispatcher.\n"
