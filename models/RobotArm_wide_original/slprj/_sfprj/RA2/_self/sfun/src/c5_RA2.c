...
static void c5_durationReferenceTimeUpdater(SFc5_RA2InstanceStruct
  *chartInstance);
static void initialize_c5_RA2(SFc5_RA2InstanceStruct *chartInstance);
static void initialize_params_c5_RA2(SFc5_RA2InstanceStruct *chartInstance);
static void enable_c5_RA2(SFc5_RA2InstanceStruct *chartInstance);
static void disable_c5_RA2(SFc5_RA2InstanceStruct *chartInstance);
static void c5_update_debugger_state_c5_RA2(SFc5_RA2InstanceStruct
  *chartInstance);
static void ext_mode_exec_c5_RA2(SFc5_RA2InstanceStruct *chartInstance);
static const mxArray *get_sim_state_c5_RA2(SFc5_RA2InstanceStruct *chartInstance);
static void set_sim_state_c5_RA2(SFc5_RA2InstanceStruct *chartInstance, const
  mxArray *c5_st);
static void c5_set_sim_state_side_effects_c5_RA2(SFc5_RA2InstanceStruct
  *chartInstance);
static void finalize_c5_RA2(SFc5_RA2InstanceStruct *chartInstance);
static void sf_gateway_c5_RA2(SFc5_RA2InstanceStruct *chartInstance);
static void mdl_start_c5_RA2(SFc5_RA2InstanceStruct *chartInstance);
static void c5_chartstep_c5_RA2(SFc5_RA2InstanceStruct *chartInstance);
static void initSimStructsc5_RA2(SFc5_RA2InstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c5_machineNumber, uint32_T
  c5_chartNumber, uint32_T c5_instanceNumber);
static const mxArray *c5_sf_marshallOut(void *chartInstanceVoid, void *c5_inData);
static int32_T c5_emlrt_marshallIn(SFc5_RA2InstanceStruct *chartInstance, const
  mxArray *c5_u, const emlrtMsgIdentifier *c5_parentId);
static void c5_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c5_mxArrayInData, const char_T *c5_varName, void *c5_outData);
static const mxArray *c5_b_sf_marshallOut(void *chartInstanceVoid, void
  *c5_inData);
static real_T c5_b_emlrt_marshallIn(SFc5_RA2InstanceStruct *chartInstance, const
  mxArray *c5_b_jogSpeed, const char_T *c5_identifier);
static real_T c5_c_emlrt_marshallIn(SFc5_RA2InstanceStruct *chartInstance, const
  mxArray *c5_u, const emlrtMsgIdentifier *c5_parentId);
static void c5_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c5_mxArrayInData, const char_T *c5_varName, void *c5_outData);
static const mxArray *c5_c_sf_marshallOut(void *chartInstanceVoid, void
  *c5_inData);
static uint8_T c5_d_emlrt_marshallIn(SFc5_RA2InstanceStruct *chartInstance,
  const mxArray *c5_b_is_active_c5_RA2, const char_T *c5_identifier);
static uint8_T c5_e_emlrt_marshallIn(SFc5_RA2InstanceStruct *chartInstance,
  const mxArray *c5_u, const emlrtMsgIdentifier *c5_parentId);
static uint16_T c5_f_emlrt_marshallIn(SFc5_RA2InstanceStruct *chartInstance,
  const mxArray *c5_b_temporalCounter_i1, const char_T *c5_identifier);
static uint16_T c5_g_emlrt_marshallIn(SFc5_RA2InstanceStruct *chartInstance,
  const mxArray *c5_u, const emlrtMsgIdentifier *c5_parentId);
static const mxArray *c5_h_emlrt_marshallIn(SFc5_RA2InstanceStruct
  *chartInstance, const mxArray *c5_b_setSimStateSideEffectsInfo, const char_T
  *c5_identifier);
static const mxArray *c5_i_emlrt_marshallIn(SFc5_RA2InstanceStruct
  *chartInstance, const mxArray *c5_u, const emlrtMsgIdentifier *c5_parentId);
static const mxArray *sf_get_hover_data_for_msg(SFc5_RA2InstanceStruct
  *chartInstance, int32_T c5_ssid);
static void c5_init_sf_message_store_memory(SFc5_RA2InstanceStruct
  *chartInstance);
static void init_dsm_address_info(SFc5_RA2InstanceStruct *chartInstance);
static void init_simulink_io_address(SFc5_RA2InstanceStruct *chartInstance);
...
static void initialize_c5_RA2(SFc5_RA2InstanceStruct *chartInstance)
{
  if (sf_is_first_init_cond(chartInstance->S)) {
    initSimStructsc5_RA2(chartInstance);
  ...
  *chartInstance->c5_temporalCounter_i1 = 0U;
  *chartInstance->c5_temporalCounter_i1 = 0U;
  *chartInstance->c5_is_active_c5_RA2 = 0U;
  *chartInstance->c5_is_c5_RA2 = c5_IN_NO_ACTIVE_CHILD;
...
static void ext_mode_exec_c5_RA2(SFc5_RA2InstanceStruct *chartInstance)
{
  c5_update_debugger_state_c5_RA2(chartInstance);
}
  ...
  mxArray *c5_st)
{
  ...
  *chartInstance->c5_is_active_c5_RA2 = c5_d_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell("is_active_c5_RA2", c5_u, 10)), "is_active_c5_RA2");
  *chartInstance->c5_is_c5_RA2 = c5_d_emlrt_marshallIn(chartInstance, sf_mex_dup
    (sf_mex_getcell("is_c5_RA2", c5_u, 11)), "is_c5_RA2");
...
static void sf_gateway_c5_RA2(SFc5_RA2InstanceStruct *chartInstance)
{
  c5_set_sim_state_side_effects_c5_RA2(chartInstance);
  ...
  _SFD_DATA_RANGE_CHECK((real_T)*chartInstance->c5_homeSwitch, 0U, 1U, 0U,
                        *chartInstance->c5_sfEvent, false);
  *chartInstance->c5_sfEvent = CALL_EVENT;
  c5_chartstep_c5_RA2(chartInstance);
...
static void c5_chartstep_c5_RA2(SFc5_RA2InstanceStruct *chartInstance)
{
  ...
  if (*chartInstance->c5_is_active_c5_RA2 == 0U) {
    _SFD_CC_CALL(CHART_ENTER_ENTRY_FUNCTION_TAG, 1U, *chartInstance->c5_sfEvent);
    *chartInstance->c5_is_active_c5_RA2 = 1U;
    ...
    *chartInstance->c5_is_c5_RA2 = c5_IN_Homing;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 5U, *chartInstance->c5_sfEvent);
    ...
    *chartInstance->c5_homeControllerEnabled = 1.0;
    ...
    switch (*chartInstance->c5_is_c5_RA2) {
     case c5_IN_AirbagLeft:
      ...
      if (c5_out) {
        ...
        _SFD_CS_CALL(STATE_INACTIVE_TAG, 0U, *chartInstance->c5_sfEvent);
        *chartInstance->c5_is_c5_RA2 = c5_IN_DisableOutputs;
        _SFD_CS_CALL(STATE_ACTIVE_TAG, 3U, *chartInstance->c5_sfEvent);
     ...
     case c5_IN_CheckRobotIsON:
      ...
      if (c5_c_out) {
        ...
        _SFD_CS_CALL(STATE_INACTIVE_TAG, 2U, *chartInstance->c5_sfEvent);
        *chartInstance->c5_is_c5_RA2 = c5_IN_STOPRobotIsOFF;
        _SFD_CS_CALL(STATE_ACTIVE_TAG, 9U, *chartInstance->c5_sfEvent);
        *chartInstance->c5_StopSim = 1.0;
        ...
        _SFD_CS_CALL(STATE_INACTIVE_TAG, 2U, *chartInstance->c5_sfEvent);
        *chartInstance->c5_is_c5_RA2 = c5_IN_RobotIsON;
        _SFD_CS_CALL(STATE_ACTIVE_TAG, 8U, *chartInstance->c5_sfEvent);
        *chartInstance->c5_temporalCounter_i1 = 0U;
      }
     ...
     case c5_IN_EnableRunAndSafety:
      ...
      if (c5_d_out) {
        ...
        _SFD_CS_CALL(STATE_INACTIVE_TAG, 4U, *chartInstance->c5_sfEvent);
        *chartInstance->c5_is_c5_RA2 = c5_IN_AirbagLeft;
        _SFD_CS_CALL(STATE_ACTIVE_TAG, 0U, *chartInstance->c5_sfEvent);
        *chartInstance->c5_temporalCounter_i1 = 0U;
        ...
        *chartInstance->c5_airBagRef = -1.4;
        ...
        if (c5_e_out) {
          ...
          _SFD_CS_CALL(STATE_INACTIVE_TAG, 4U, *chartInstance->c5_sfEvent);
          *chartInstance->c5_is_c5_RA2 = c5_IN_AirbagRight;
          _SFD_CS_CALL(STATE_ACTIVE_TAG, 1U, *chartInstance->c5_sfEvent);
          *chartInstance->c5_temporalCounter_i1 = 0U;
          *chartInstance->c5_airBagEnabled = 1.0;
     ...
     case c5_IN_Homing:
      ...
      if (c5_f_out) {
        ...
        _SFD_CS_CALL(STATE_INACTIVE_TAG, 5U, *chartInstance->c5_sfEvent);
        *chartInstance->c5_is_c5_RA2 = c5_IN_MovetoX0;
        _SFD_CS_CALL(STATE_ACTIVE_TAG, 6U, *chartInstance->c5_sfEvent);
        *chartInstance->c5_temporalCounter_i1 = 0U;
        *chartInstance->c5_jogSpeed = 0.0;
     ...
     case c5_IN_MovetoX0:
      ...
      if (c5_g_out) {
        ...
        _SFD_CS_CALL(STATE_INACTIVE_TAG, 6U, *chartInstance->c5_sfEvent);
        *chartInstance->c5_is_c5_RA2 = c5_IN_CheckRobotIsON;
        _SFD_CS_CALL(STATE_ACTIVE_TAG, 2U, *chartInstance->c5_sfEvent);
      } else {
     ...
     case c5_IN_ResetEnc:
      ...
      if (c5_h_out) {
        ...
        _SFD_CS_CALL(STATE_INACTIVE_TAG, 7U, *chartInstance->c5_sfEvent);
        *chartInstance->c5_is_c5_RA2 = c5_IN_EnableRunAndSafety;
        _SFD_CS_CALL(STATE_ACTIVE_TAG, 4U, *chartInstance->c5_sfEvent);
        *chartInstance->c5_resetEnc = 0.0;
     ...
     case c5_IN_RobotIsON:
      ...
      if (c5_i_out) {
        ...
        _SFD_CS_CALL(STATE_INACTIVE_TAG, 8U, *chartInstance->c5_sfEvent);
        *chartInstance->c5_is_c5_RA2 = c5_IN_WaitForRest;
        _SFD_CS_CALL(STATE_ACTIVE_TAG, 10U, *chartInstance->c5_sfEvent);
        *chartInstance->c5_Ready = 1.0;
     ...
     case c5_IN_WaitForRest:
      ...
      if (c5_j_out) {
        ...
        _SFD_CS_CALL(STATE_INACTIVE_TAG, 10U, *chartInstance->c5_sfEvent);
        *chartInstance->c5_is_c5_RA2 = c5_IN_ResetEnc;
        _SFD_CS_CALL(STATE_ACTIVE_TAG, 7U, *chartInstance->c5_sfEvent);
        *chartInstance->c5_temporalCounter_i1 = 0U;
...
const mxArray *sf_c5_RA2_get_eml_resolved_functions_info(void)
{
...
static const mxArray *c5_sf_marshallOut(void *chartInstanceVoid, void *c5_inData)
{
  ...
  int32_T c5_u;
  const mxArray *c5_y = NULL;
  SFc5_RA2InstanceStruct *chartInstance;
  chartInstance = (SFc5_RA2InstanceStruct *)chartInstanceVoid;
  ...
  const mxArray *c5_b_is_active_c5_RA2, const char_T *c5_identifier)
{
  ...
  c5_thisId.fParent = NULL;
  c5_thisId.bParentIsCell = false;
  c5_y = c5_e_emlrt_marshallIn(chartInstance, sf_mex_dup(c5_b_is_active_c5_RA2),
    &c5_thisId);
  sf_mex_destroy(&c5_b_is_active_c5_RA2);
  return c5_y;
}
...
static void init_simulink_io_address(SFc5_RA2InstanceStruct *chartInstance)
{
  ...
  chartInstance->c5_isStable = (boolean_T *)ssGetDWork_wrapper(chartInstance->S,
    1);
  chartInstance->c5_is_active_c5_RA2 = (uint8_T *)ssGetDWork_wrapper
    (chartInstance->S, 2);
  chartInstance->c5_is_c5_RA2 = (uint8_T *)ssGetDWork_wrapper(chartInstance->S,
    3);
...
void sf_c5_RA2_get_check_sum(mxArray *plhs[])
{
...
mxArray* sf_c5_RA2_get_post_codegen_info(void);
mxArray *sf_c5_RA2_get_autoinheritance_info(void)
{
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c5_RA2_get_post_codegen_info();
...
mxArray *sf_c5_RA2_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c5_RA2_jit_fallback_info(void)
{
...
mxArray *sf_c5_RA2_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c5_RA2(void)
{
  ...
  const char *infoEncStr[] = {
    ...
    "100 S1x3'type','srcId','name','auxInfo'{{M[8],M[0],T\"is_active_c5_RA2\",},{M[9],M[0],T\"is_c5_RA2\",},{M[11],M[0],T\"temporalCounter_i1\",S'et','os','ct'{{T\"at\",M1x5[19 71 58 74 102],M[1]}}}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 13, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c5_RA2_get_check_sum(&mxChecksum);
...
static const mxArray* sf_opaque_get_hover_data_for_msg(void* chartInstance,
  int32_T msgSSID)
{
  return sf_get_hover_data_for_msg( (SFc5_RA2InstanceStruct *) chartInstance,
    msgSSID);
}
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc5_RA2InstanceStruct *chartInstance = (SFc5_RA2InstanceStruct *)
...
static void sf_opaque_initialize_c5_RA2(void *chartInstanceVar)
{
  sf_check_dwork_consistency(((SFc5_RA2InstanceStruct*) chartInstanceVar)->S);
  chart_debug_initialization(((SFc5_RA2InstanceStruct*) chartInstanceVar)->S,0);
  initialize_params_c5_RA2((SFc5_RA2InstanceStruct*) chartInstanceVar);
  initialize_c5_RA2((SFc5_RA2InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c5_RA2(void *chartInstanceVar)
{
  enable_c5_RA2((SFc5_RA2InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c5_RA2(void *chartInstanceVar)
{
  disable_c5_RA2((SFc5_RA2InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c5_RA2(void *chartInstanceVar)
{
  sf_gateway_c5_RA2((SFc5_RA2InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_ext_mode_exec_c5_RA2(void *chartInstanceVar)
{
  ext_mode_exec_c5_RA2((SFc5_RA2InstanceStruct*) chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c5_RA2(SimStruct* S)
{
  return get_sim_state_c5_RA2((SFc5_RA2InstanceStruct *)
    sf_get_chart_instance_ptr(S));     /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c5_RA2(SimStruct* S, const mxArray *st)
{
  set_sim_state_c5_RA2((SFc5_RA2InstanceStruct*)sf_get_chart_instance_ptr(S), st);
}

static void sf_opaque_terminate_c5_RA2(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc5_RA2InstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
      unload_RA2_optimization_info();
    }

    finalize_c5_RA2((SFc5_RA2InstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc5_RA2((SFc5_RA2InstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c5_RA2(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c5_RA2((SFc5_RA2InstanceStruct*)sf_get_chart_instance_ptr
      (S));
  }
}

mxArray *sf_c5_RA2_get_testpoint_info(void)
{
  const char *infoEncStr[] = {
    "100 S1x2'varName','path'{{T\"is_active_c5_RA2\",T\"is_active_c5_RA2\"},{T\"is_c5_RA2\",T\"is_c5_RA2\"}}"
  };
...
static void mdlSetWorkWidths_c5_RA2(SimStruct *S)
{
...
static void mdlRTW_c5_RA2(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c5_RA2(SimStruct *S)
{
  SFc5_RA2InstanceStruct *chartInstance;
  chartInstance = (SFc5_RA2InstanceStruct *)utMalloc(sizeof
    (SFc5_RA2InstanceStruct));
  if (chartInstance==NULL) {
    sf_mex_error_message("Could not allocate memory for chart instance.");
  }

  memset(chartInstance, 0, sizeof(SFc5_RA2InstanceStruct));
  chartInstance->chartInfo.chartInstance = chartInstance;
  chartInstance->chartInfo.isEMLChart = 0;
  chartInstance->chartInfo.chartInitialized = 0;
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c5_RA2;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c5_RA2;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c5_RA2;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c5_RA2;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c5_RA2;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c5_RA2;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c5_RA2;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c5_RA2;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c5_RA2;
  chartInstance->chartInfo.mdlStart = mdlStart_c5_RA2;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c5_RA2;
  chartInstance->chartInfo.callGetHoverDataForMsg =
    sf_opaque_get_hover_data_for_msg;
  chartInstance->chartInfo.extModeExec = sf_opaque_ext_mode_exec_c5_RA2;
  ...
  mdl_start_c5_RA2(chartInstance);
}

void c5_RA2_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   ...
   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c5_RA2(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c5_RA2(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c5_RA2_method_dispatcher.\n"
