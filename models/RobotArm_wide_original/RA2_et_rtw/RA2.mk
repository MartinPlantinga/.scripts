...
#
# File    : RA2.mk   $Revision: 1.81.4.22.2.1 $
#
# Abstract:
...
MODEL                = RA2
MODULES              = RA2_data.c rtGetInf.c rtGetNaN.c rt_logging.c rt_matrx.c rt_nonfinite.c rt_printf.c 
MAKEFILE             = RA2.mk
MATLAB_ROOT          = /home/ebox/MATLAB/R2015b
ALT_MATLAB_ROOT      = /home/ebox/MATLAB/R2015b
S_FUNCTIONS          = rtiostream_utils.c sf_rt_scope.c ec_Ebox.c dweakint.c dpd.c dnotch.c dlowpass2.c ec_EboxResetEnc.c
S_FUNCTIONS_LIB      = 
SOLVER               = 
NUMST                = 2
TID01EQ              = 1
...
ADD_INCLUDES = \
	-I/home/lubuntu/Documents/RobotArm_wide_original/RA2_et_rtw \
