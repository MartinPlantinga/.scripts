...
#ifndef RTW_HEADER_RA2_h_
#define RTW_HEADER_RA2_h_
#include <stddef.h>
#include <string.h>
#include <math.h>
#ifndef RA2_COMMON_INCLUDES_
# define RA2_COMMON_INCLUDES_
#include "rtwtypes.h"
...
#define RA2_rtModel                    RT_MODEL_RA2_T
...
typedef struct {
  ...
  uint8_T is_active_c7_RA2;            /* '<S15>/Supervisor' */
  uint8_T is_c7_RA2;                   /* '<S15>/Supervisor' */
  uint8_T is_active_c6_RA2;            /* '<S14>/Supervisor' */
  uint8_T is_c6_RA2;                   /* '<S14>/Supervisor' */
  uint8_T is_active_c5_RA2;            /* '<S13>/Supervisor' */
  uint8_T is_c5_RA2;                   /* '<S13>/Supervisor' */
...
#define rtB                            RA2_B
#define BlockIO                        B_RA2_T
#define rtP                            RA2_P
#define Parameters                     P_RA2_T
#define rtDWork                        RA2_DW
#define D_Work                         DW_RA2_T
...
extern P_RA2_T RA2_P;

/* Block signals (auto storage) */
extern B_RA2_T RA2_B;

/* Block states (auto storage) */
extern DW_RA2_T RA2_DW;

/* External data declarations for dependent source files */
extern const real_T RA2_RGND;          /* real_T ground */

/* Model entry point functions */
extern void RA2_initialize(void);
extern void RA2_output(void);
extern void RA2_update(void);
extern void RA2_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern RA2_rtModel *RA2(void);
...
extern RT_MODEL_RA2_T *const RA2_M;
 ...
 * '<S1>'   : 'RA2/Controller'
 * '<S2>'   : 'RA2/Robot Arm'
 * '<S3>'   : 'RA2/Controller/Controller R'
 * '<S4>'   : 'RA2/Controller/Controller X'
 * '<S5>'   : 'RA2/Controller/Controller Z'
 * '<S6>'   : 'RA2/Controller/RTScope'
 * '<S7>'   : 'RA2/Robot Arm/IO'
 * '<S8>'   : 'RA2/Robot Arm/Supervisor'
 * '<S9>'   : 'RA2/Robot Arm/IO/E-box'
 * '<S10>'  : 'RA2/Robot Arm/IO/E-box1'
 * '<S11>'  : 'RA2/Robot Arm/Supervisor/Compare To Constant'
 * '<S12>'  : 'RA2/Robot Arm/Supervisor/HomingBusyCheck'
 * '<S13>'  : 'RA2/Robot Arm/Supervisor/Supervisory Controller R'
 * '<S14>'  : 'RA2/Robot Arm/Supervisor/Supervisory Controller X'
 * '<S15>'  : 'RA2/Robot Arm/Supervisor/Supervisory Controller Z'
 * '<S16>'  : 'RA2/Robot Arm/Supervisor/Supervisory Controller R/ControllerR'
 * '<S17>'  : 'RA2/Robot Arm/Supervisor/Supervisory Controller R/ControllerR1'
 * '<S18>'  : 'RA2/Robot Arm/Supervisor/Supervisory Controller R/Point-to-point trajectory'
 * '<S19>'  : 'RA2/Robot Arm/Supervisor/Supervisory Controller R/Selector'
 * '<S20>'  : 'RA2/Robot Arm/Supervisor/Supervisory Controller R/Selector1'
 * '<S21>'  : 'RA2/Robot Arm/Supervisor/Supervisory Controller R/Selector2'
 * '<S22>'  : 'RA2/Robot Arm/Supervisor/Supervisory Controller R/Supervisor'
 * '<S23>'  : 'RA2/Robot Arm/Supervisor/Supervisory Controller R/Point-to-point trajectory/Discrete Derivative'
 * '<S24>'  : 'RA2/Robot Arm/Supervisor/Supervisory Controller X/ControllerX'
 * '<S25>'  : 'RA2/Robot Arm/Supervisor/Supervisory Controller X/ControllerX1'
 * '<S26>'  : 'RA2/Robot Arm/Supervisor/Supervisory Controller X/Point-to-point trajectory'
 * '<S27>'  : 'RA2/Robot Arm/Supervisor/Supervisory Controller X/Selector'
 * '<S28>'  : 'RA2/Robot Arm/Supervisor/Supervisory Controller X/Selector1'
 * '<S29>'  : 'RA2/Robot Arm/Supervisor/Supervisory Controller X/Selector2'
 * '<S30>'  : 'RA2/Robot Arm/Supervisor/Supervisory Controller X/Selector3'
 * '<S31>'  : 'RA2/Robot Arm/Supervisor/Supervisory Controller X/Supervisor'
 * '<S32>'  : 'RA2/Robot Arm/Supervisor/Supervisory Controller X/Point-to-point trajectory/Discrete Derivative'
 * '<S33>'  : 'RA2/Robot Arm/Supervisor/Supervisory Controller Z/Angle2Z'
 * '<S34>'  : 'RA2/Robot Arm/Supervisor/Supervisory Controller Z/Controller1'
 * '<S35>'  : 'RA2/Robot Arm/Supervisor/Supervisory Controller Z/Controller2'
 * '<S36>'  : 'RA2/Robot Arm/Supervisor/Supervisory Controller Z/Point-to-point trajectory'
 * '<S37>'  : 'RA2/Robot Arm/Supervisor/Supervisory Controller Z/Selector'
 * '<S38>'  : 'RA2/Robot Arm/Supervisor/Supervisory Controller Z/Selector1'
 * '<S39>'  : 'RA2/Robot Arm/Supervisor/Supervisory Controller Z/Selector2'
 * '<S40>'  : 'RA2/Robot Arm/Supervisor/Supervisory Controller Z/Selector3'
 * '<S41>'  : 'RA2/Robot Arm/Supervisor/Supervisory Controller Z/Supervisor'
 * '<S42>'  : 'RA2/Robot Arm/Supervisor/Supervisory Controller Z/Point-to-point trajectory/Discrete Derivative'
 */
#endif                                 /* RTW_HEADER_RA2_h_ */
