 ...
 *
 * Code generation for model "RA4_student".
 *
 * Model version              : 1.904
 * Simulink Coder version : 8.9 (R2015b) 13-Aug-2015
 * C source code generated on : Thu Apr 21 18:56:05 2016
 *
...
#ifndef RTW_HEADER_RA4_student_h_
#define RTW_HEADER_RA4_student_h_
#include <stddef.h>
#include <string.h>
#ifndef RA4_student_COMMON_INCLUDES_
# define RA4_student_COMMON_INCLUDES_
#include "rtwtypes.h"
...
#include "dt_info.h"
#include "ext_work.h"
#endif                                 /* RA4_student_COMMON_INCLUDES_ */

#include "RA4_student_types.h"
...
#define RA4_student_rtModel            RT_MODEL_RA4_student_T
...
typedef struct {
  ...
  uint16_T RobotArm_sfcn_DWORK38;      /* '<S2>/Robot Arm_sfcn' */
  uint16_T RobotArm_sfcn_DWORK39;      /* '<S2>/Robot Arm_sfcn' */
  uint16_T RobotArm_sfcn_DWORK40;      /* '<S2>/Robot Arm_sfcn' */
  int8_T Controller_SubsysRanBC;       /* '<Root>/Controller' */
  uint8_T RobotArm_sfcn_DWORK41;       /* '<S2>/Robot Arm_sfcn' */
  uint8_T RobotArm_sfcn_DWORK42;       /* '<S2>/Robot Arm_sfcn' */
  uint8_T RobotArm_sfcn_DWORK43;       /* '<S2>/Robot Arm_sfcn' */
  uint8_T RobotArm_sfcn_DWORK44;       /* '<S2>/Robot Arm_sfcn' */
  uint8_T RobotArm_sfcn_DWORK45;       /* '<S2>/Robot Arm_sfcn' */
  uint8_T RobotArm_sfcn_DWORK46;       /* '<S2>/Robot Arm_sfcn' */
  boolean_T Controller_MODE;           /* '<Root>/Controller' */
} DW_RA4_student_T;

/* Backward compatible GRT Identifiers */
#define rtB                            RA4_student_B
#define BlockIO                        B_RA4_student_T
#define rtP                            RA4_student_P
#define Parameters                     P_RA4_student_T
#define rtDWork                        RA4_student_DW
#define D_Work                         DW_RA4_student_T

/* Parameters (auto storage) */
struct P_RA4_student_T_ {
...
struct tag_RTM_RA4_student_T {
  ...
  struct {
    ...
    struct {
      ...
      struct _ssDWorkRecord dWork[47];
      struct _ssDWorkAuxRecord dWorkAux[47];
    } Sfcn1;
  } NonInlinedSFcns;
...
extern P_RA4_student_T RA4_student_P;

/* Block signals (auto storage) */
extern B_RA4_student_T RA4_student_B;

/* Block states (auto storage) */
extern DW_RA4_student_T RA4_student_DW;

/* External data declarations for dependent source files */
extern const real_T RA4_student_RGND;  /* real_T ground */

/* Model entry point functions */
extern void RA4_student_initialize(void);
extern void RA4_student_output(void);
extern void RA4_student_update(void);
extern void RA4_student_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern RA4_student_rtModel *RA4_student(void);
...
extern RT_MODEL_RA4_student_T *const RA4_student_M;
 ...
 *
 * '<Root>' : 'RA4_student'
 * '<S1>'   : 'RA4_student/Controller'
 * '<S2>'   : 'RA4_student/Robot Arm1'
 * '<S3>'   : 'RA4_student/Controller/Controller R'
 * '<S4>'   : 'RA4_student/Controller/Controller X'
 * '<S5>'   : 'RA4_student/Controller/Controller Z'
 * '<S6>'   : 'RA4_student/Controller/RTScope'
 * '<S7>'   : 'RA4_student/Robot Arm1/__InputSSForSFun__'
 * '<S8>'   : 'RA4_student/Robot Arm1/__OutputSSForSFun__'
 */
#endif                                 /* RTW_HEADER_RA4_student_h_ */
