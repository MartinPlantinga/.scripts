...
#include "RA4_student.h"
#include "RA4_student_private.h"
#include "RA4_student_dt.h"
...
const real_T RA4_student_RGND = 0.0;   /* real_T ground */

/* Block signals (auto storage) */
B_RA4_student_T RA4_student_B;

/* Block states (auto storage) */
DW_RA4_student_T RA4_student_DW;

/* Real-time model */
RT_MODEL_RA4_student_T RA4_student_M_;
RT_MODEL_RA4_student_T *const RA4_student_M = &RA4_student_M_;
...
void MdlStart(void)
{
  RA4_student_initialize();
}

void MdlTerminate(void)
{
  RA4_student_terminate();
}
